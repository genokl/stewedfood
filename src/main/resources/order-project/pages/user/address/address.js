...
Page({
  ...
  formSubmit: function (e) {
    ...
    // var xcxLoginMemberId = wx.getStorageSync("xcxLoginMemberId");
    adds["memberId"] = wx.getStorageSync("xcxLoginMemberId");
    // console.log(adds)
    comm.globalObj.requestPostHttps("/xcx/logistic/update", adds, function (d) {
      if (d.statusCode == 1) {
        console.log(d)
        if (d.info != null) {
          that.setData({
  ...
  onLoad: function (options) {
    ...
    var that = this;
    var xcxLoginMemberId=wx.getStorageSync("xcxLoginMemberId");
    comm.globalObj.requestGetHttps("/xcx/logistic/self", { "memberId": xcxLoginMemberId}, function (d) {
      if (d.statusCode == 1) {
        // console.log(d)
        if(d.info!=null){
          that.setData({
